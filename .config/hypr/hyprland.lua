...
hl.curve("spring",         { type = "bezier", points = { {0.25, 1.5},  {0.35, 1}    } })
hl.curve("bounce",         { type = "bezier", points = { {0.55, 1.55}, {0.65, 1}    } })
...
hl.animation({ leaf = "windows",     enabled = true, speed = 6, bezier = "spring" })
hl.animation({ leaf = "windowsIn",   enabled = true, speed = 5, bezier = "bounce", style = "popin 90%" })
hl.animation({ leaf = "windowsOut",  enabled = true, speed = 1, bezier = "easeOutQuint", style = "popin 80%" })

hl.animation({ leaf = "fadeIn",  enabled = true, speed = 2.5, bezier = "spring" })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 1.8, bezier = "easeOutQuint" })
hl.animation({ leaf = "fade",    enabled = true, speed = 4,   bezier = "quick" })

hl.animation({ leaf = "layers",     enabled = true, speed = 5, bezier = "spring", style = "slidefade 40%" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 4, bezier = "default", style = "slidefade 30%" })
